<x-layout>
    <div class="container-fluid products text-white texy-colr text-center">
        <div class="row">
            <h2 class="display-4 text-dark shadow">Inserisci una nuova categoria</h2>
        </div>
        <div class="row h-100 justify-content-center align-items-center py-5">
            <div class="col-12 col-md-8">
                ...
                @endif
                <form action="{{ route('genre.submit') }}" method="POST" class="bg-dark p-5 rounded">
                    @csrf
                    <div class="mb-3">
